...
- **Dependency Management**: Poetry (declared in `pyproject.toml`).
...
│   └── memos_mcp/             # MCP server implementation
├── scripts/                   # Reorganized Utility Scripts
│   ├── db-ops/                # Database and vector operations
│   ├── maintenance/           # Logging and cleanup
│   ├── startup/               # Build and run scripts
...
- Poetry
- Access to PostgreSQL, Redis, and Neo4j instances
